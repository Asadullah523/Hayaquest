...
export const DailyTasksWidget: React.FC = React.memo(() => {
  ...
  // Load topics when subjects are available (separate effect to avoid loop)
  useEffect(() => {
  ...
  const getDurationInMinutes = (start: string, end: string) => {
    ...
    // Handle midnight crossing (if end is 00:00, it becomes 1440)
  ...
  return (
    <div className="glass-card rounded-3xl 2xl:rounded-[2.5rem] p-5 sm:p-6 md:p-6 2xl:p-8">
