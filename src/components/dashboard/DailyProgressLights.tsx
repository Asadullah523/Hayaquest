...
export const DailyProgressLights: React.FC = () => {
  ...
  return (
    <div className="flex items-center justify-center gap-1 sm:gap-2 2xl:gap-3 mt-4 px-1">
      {weekDays.map((day, i) => (
        <div key={i} className="flex flex-col items-center gap-1 sm:gap-1.5 2xl:gap-2 group relative">
          <div 
            className={`
                w-2.5 h-2.5 sm:w-3.5 sm:h-3.5 2xl:w-4 2xl:h-4 rounded-full transition-all duration-500 relative
                ${day.hasActivity 
