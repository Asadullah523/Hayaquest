  ...
  return (
    <div className="space-y-4">
        <div className="flex justify-between items-center">
            <h2 className="text-2xl lg:text-xl 2xl:text-2xl font-bold text-gray-800 dark:text-white">Weekly Schedule</h2>
            <button 
            ...
            <div className="overflow-x-auto pb-4">
                <div className="min-w-[600px] border border-gray-200 dark:border-slate-600 rounded-xl overflow-hidden bg-white dark:bg-slate-700 shadow-sm select-none">
                    ...
                    <div className="grid grid-cols-8 border-b border-gray-200 dark:border-slate-600 bg-white dark:bg-slate-700 sticky top-0 z-20">
                        <div className="p-3 lg:p-2 lg:py-3 2xl:p-3 2xl:py-4 text-xs font-medium text-gray-400 dark:text-slate-400 text-center uppercase tracking-wider py-4 bg-white dark:bg-slate-700 sticky left-0 z-30">Time</div>
                        {DAYS.map((day) => (
                            <div key={day} className="p-3 lg:p-2 lg:py-3 2xl:p-3 2xl:py-4 text-xs font-bold text-gray-600 dark:text-white text-center uppercase tracking-wider py-4 border-l border-gray-100 dark:border-slate-600">
                                {day}
                            </div>
                        ))}
                    </div>
                    ...
                    <div className="divide-y divide-gray-100 dark:divide-slate-600">
                        {TIMES.map(time => (
                            <div key={time} className="grid grid-cols-8 h-12 lg:h-10 2xl:h-12">
        ...
        {selectedCell && (
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                ...
                />
                <div className="relative w-full max-w-sm bg-white dark:bg-slate-800 rounded-3xl shadow-2xl p-5 sm:p-6 lg:p-4 2xl:p-6 transform transition-all animate-fade-in max-h-[85vh] overflow-y-auto">
                    <div className="flex justify-between items-center mb-4 sm:mb-6 lg:mb-3 2xl:mb-6 sticky top-0 bg-white dark:bg-slate-800 z-10 py-1">
                        <div>
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="flex gap-2">
                                <input
                                    ...
                                    className="flex-1 p-3.5 lg:p-2.5 2xl:p-3.5 rounded-2xl bg-gray-50 dark:bg-slate-900 border border-transparent focus:border-primary/30 focus:ring-4 focus:ring-primary/10 transition-all outline-none dark:text-white text-sm"
                                    onKeyDown={(e) => {
                                ...
                                <button 
                                    ...
                                    className="p-3.5 lg:p-2.5 2xl:p-3.5 rounded-2xl bg-primary text-white shadow-lg shadow-primary/20 hover:scale-105 active:scale-95 transition-all disabled:opacity-50 disabled:grayscale disabled:scale-100"
                                    title="Save Activity"
                                >
                                    <Plus size={24} />
                                </button>
