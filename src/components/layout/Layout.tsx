...
export const Layout: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-transparent flex flex-col md:flex-row relative">
      ...
      {/* Main Content Area */}
      <main className="flex-1 xl:ml-[280px] min-h-screen pb-32 md:pb-0 relative z-10 transition-all duration-300">
      ...
      <div className="xl:hidden fixed bottom-6 left-6 right-6 z-[100] animate-slide-up">
