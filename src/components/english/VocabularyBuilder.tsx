    ...
    return (
        <div className="relative min-h-[80vh] flex flex-col items-center justify-start pb-12 pt-6 overflow-hidden px-4 md:pt-10">
            ...
            <div className="w-full max-w-5xl space-y-6 md:space-y-12 relative z-10">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 md:gap-8">
                    <div className="flex items-center gap-4 md:gap-6">
                        ...
                        <div className="min-w-0">
                            <h1 className="text-xl sm:text-2xl md:text-5xl lg:text-3xl 2xl:text-5xl font-black text-slate-900 dark:text-white tracking-tighter mb-0.5 sm:mb-1 md:mb-2 truncate">
                ...
                {sessionWords.length > 0 ? (
                    <div 
                        className="max-w-[320px] md:max-w-[400px] lg:max-w-[340px] 2xl:max-w-[400px] w-full mx-auto"
                        onMouseMove={handleMouseMove}
                        onMouseLeave={handleMouseLeave}
                    >
                        <div className="perspective-2000 w-full aspect-[3/4] md:aspect-[4/5] lg:aspect-[1/1.2] 2xl:aspect-[4/5] relative mb-8">
                            <AnimatePresence mode="wait">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        {/* FRONT SIDE */}
                                        <div 
                                            className="absolute inset-0 bg-white/80 dark:bg-slate-900/80 backdrop-blur-3xl rounded-[2rem] sm:rounded-[2.5rem] md:rounded-[3.5rem] border border-white/40 dark:border-slate-800/50 shadow-2xl backface-hidden flex flex-col items-center justify-center p-5 sm:p-6 md:p-12 lg:p-6 2xl:p-12 text-center group z-10"
                                        ...
                                        >
                                            ...
                                            <div className="relative mb-4 sm:mb-6 md:mb-8 w-full flex-1 flex items-center justify-center">
                                                ...
                                                <h2 className="text-2xl sm:text-3xl md:text-5xl lg:text-3xl 2xl:text-5xl font-black text-slate-900 dark:text-white tracking-tighter leading-none relative z-10 pointer-events-none break-words px-2">
                                                    {currentWord.word}
                                                </h2>
                                            </div>
                                        ...
                                        {/* BACK SIDE */}
                                        <div 
                                            className="absolute inset-0 bg-slate-950 rounded-[2rem] sm:rounded-[2.5rem] md:rounded-[3.5rem] border border-slate-800 shadow-2xl flex flex-col justify-between p-5 sm:p-6 md:p-12 lg:p-8 2xl:p-12 overflow-hidden text-left z-20"
                                            style={{ 
