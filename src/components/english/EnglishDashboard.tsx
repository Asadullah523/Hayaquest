        ...
        >
          ...
          <motion.div variants={item} className="flex flex-col md:flex-row md:items-end justify-between gap-3 sm:gap-4 md:gap-6">
            <div>
              ...
              <h1 className="text-2xl sm:text-3xl md:text-5xl lg:text-3xl 2xl:text-5xl font-black text-slate-900 dark:text-white tracking-tighter">
              ...
              <p className="text-xs sm:text-sm md:text-lg lg:text-sm 2xl:text-lg text-slate-500 dark:text-slate-400 mt-1 md:mt-2 max-w-2xl leading-relaxed">
                Your journey to fluency. Master vocabulary, reading, and grammar.
              </p>
            </div>
            
            <div className="flex gap-2 sm:gap-3 md:gap-4">
                 <div className="bg-white dark:bg-slate-800 p-2.5 sm:p-3 md:p-4 lg:p-3 2xl:p-4 rounded-2xl md:rounded-[1.5rem] shadow-xl shadow-slate-200/50 dark:shadow-none border border-slate-100 dark:border-slate-700 min-w-[90px] sm:min-w-[100px] md:min-w-[120px] relative overflow-hidden group">
                     ...
                     <div className="relative z-10">
                         ...
                         <p className="text-lg sm:text-xl md:text-3xl lg:text-2xl 2xl:text-3xl font-black text-slate-800 dark:text-white">{dailyStreak} <span className="text-sm sm:text-base md:text-xl">🔥</span></p>
                     </div>
                 </div>
                     ...
                     <div className="relative z-10">
                         ...
                         <p className="text-lg sm:text-xl md:text-3xl lg:text-2xl 2xl:text-3xl font-black text-slate-800 dark:text-white">{wordsLearned.length}</p>
                     </div>
                 </div>
            </div>
          </motion.div>
          ...
          {/* Feature Grid */}
          <motion.div variants={item} className="grid grid-cols-2 lg:grid-cols-2 gap-3 md:gap-4 lg:gap-3 2xl:gap-4">
              ...
              return (
                 ...
                 >
                   ...
                   <div className="relative z-10">
                       ...
                       <h3 className="text-base sm:text-lg md:text-2xl lg:text-lg 2xl:text-2xl font-bold text-slate-800 dark:text-white mb-0.5 sm:mb-1 md:mb-2 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-indigo-600 group-hover:to-violet-600 transition-all truncate">
                         {section.title}
                       </h3>
                       <p className="text-[10px] sm:text-xs md:text-base lg:text-xs 2xl:text-base text-slate-500 dark:text-slate-400 font-medium leading-relaxed max-w-sm line-clamp-2 md:line-clamp-none">
                         {section.description}
                       </p>
          ...
          <motion.div variants={item} className="mt-8 bg-gradient-to-r from-slate-900 to-indigo-900 rounded-[2rem] p-6 md:p-10 lg:p-6 2xl:p-10 text-center relative overflow-hidden">
              <div className="absolute top-0 left-0 w-full h-full bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] opacity-10"></div>
              <div className="relative z-10 max-w-3xl mx-auto">
                  <Sparkles className="mx-auto text-yellow-400 mb-4" size={24} />
                  <h2 className="text-xl md:text-3xl lg:text-2xl 2xl:text-3xl font-serif italic text-white leading-relaxed mb-4">
