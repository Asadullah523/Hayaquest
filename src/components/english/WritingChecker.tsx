...
export const WritingChecker: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-4 md:space-y-6 lg:space-y-4 2xl:space-y-6">
      {/* Header */}
      ...
      <div className="grid grid-cols-3 md:grid-cols-3 lg:grid-cols-5 gap-2 md:gap-4 px-1">
        {[
          ...
          <div key={i} className={clsx(
            "bg-white dark:bg-slate-800 p-2 md:p-5 lg:p-3 2xl:p-5 rounded-xl md:rounded-2xl border border-slate-100 dark:border-slate-700 shadow-sm",
      ...
      {/* Main Content */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-4 2xl:gap-6">
        {/* Editor */}
        <div className={`lg:col-span-2 ${activeTab !== 'write' ? 'hidden lg:block' : ''}`}>
          <div className="bg-white dark:bg-slate-800 rounded-2xl md:rounded-[2.5rem] border border-slate-100 dark:border-slate-700 shadow-xl overflow-hidden">
            ...
            <div className="h-[400px] md:h-[600px] lg:h-[450px] 2xl:h-[600px] overflow-hidden">
              <WritingEditor
                text={text}
                setText={setText}
                errors={errors}
        ...
        <div className={`lg:col-span-1 ${activeTab !== 'analyze' ? 'hidden lg:block' : ''}`}>
          <div className="bg-white dark:bg-slate-800 rounded-2xl md:rounded-[2.5rem] border border-slate-100 dark:border-slate-700 shadow-xl overflow-hidden flex flex-col h-full max-h-[675px] md:max-h-none lg:max-h-[520px] 2xl:max-h-none">
            {/* Health Score Header */}
      ...
      {(text.trim() && (activeTab === 'analyze' || window.innerWidth > 1024)) && (
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          className="bg-white dark:bg-slate-800 rounded-2xl md:rounded-[2.5rem] border border-slate-100 dark:border-slate-700 shadow-xl p-6 md:p-8 lg:p-4 2xl:p-8"
        >
