                ...
                <div className="space-y-8 animate-in fade-in duration-500">
                    <div className="space-y-6">
                        <div className="flex items-center gap-3">
                            ...
                            <h2 className="text-3xl md:text-4xl lg:text-2xl 2xl:text-4xl font-black text-slate-800 dark:text-white tracking-tighter">
                                {selectedTopic.title}
                            </h2>
                        </div>
              ...
              <div className="md:sticky md:top-8">
                  ...
                  {selectedTopic ? (
                      <motion.div 
                        ...
                        className="bg-white dark:bg-slate-800 rounded-[2.5rem] border border-slate-100 dark:border-slate-700 shadow-xl overflow-hidden h-[calc(100vh-12rem)] lg:h-[calc(100vh-10rem)] 2xl:h-[calc(100vh-12rem)] min-h-[600px] flex flex-col relative"
                      >
                          ...
                          <div className="p-8 md:p-12 lg:p-8 2xl:p-12 flex-1 overflow-y-auto custom-scrollbar">
                              {renderTopicContent()}
                          </div>
                      </motion.div>
                  ) : (
