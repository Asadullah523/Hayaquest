      ...
      <div className={`max-w-7xl mx-auto ${selectedStory ? 'px-0 py-2 md:p-8' : 'p-4 md:p-8'} ${isZenMode ? 'max-w-4xl' : ''}`}>
        ...
        {!selectedStory ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {filteredStories.map((story) => (
                        <motion.button
                            ...
                            className="bg-white dark:bg-slate-800 p-6 lg:p-4 2xl:p-6 rounded-[2rem] border border-slate-100 dark:border-slate-700 shadow-xl shadow-slate-200/50 dark:shadow-none hover:scale-[1.02] transition-all text-left group flex flex-col h-full"
                        >
                            ...
                            <h3 className="text-lg sm:text-xl lg:text-base 2xl:text-xl font-bold text-slate-800 dark:text-white mb-2 group-hover:text-indigo-600 transition-colors">
                                {story.title}
                            </h3>
            ...
            >
                {/* Story Content Card */}
                <div className={`
                    rounded-xl md:rounded-[2rem] p-3 md:p-16 lg:p-8 2xl:p-16 shadow-xl transition-all duration-500 min-h-[80vh]
                    ${sepiaMode 
                ...
                `}>
                    <div className="text-center mb-12">
                        ...
                        <h1 className="text-2xl sm:text-4xl md:text-5xl lg:text-3xl 2xl:text-5xl font-black tracking-tight mb-4 sm:mb-6 font-serif">
                            {selectedStory.title}
                        </h1>
