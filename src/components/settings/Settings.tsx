...
export const Settings: React.FC = () => {
  ...
  const handleReset = async () => {
      ...
      try {
          ...
          // Set heatmap start date to now so the Activity Consistency starts fresh
  ...
  return (
    <div className="space-y-4 sm:space-y-8 animate-fade-in p-2 max-w-2xl mx-auto">
      <div>
        <h1 className="text-3xl lg:text-2xl 2xl:text-3xl font-extrabold text-gray-900 dark:text-white mb-2 tracking-tight">Settings</h1>
        <p className="text-gray-500 dark:text-gray-400 lg:text-sm 2xl:text-base">Customize your experience and manage your data.</p>
      </div>

      {/* Personal Profile */}
      <div className="bg-white dark:bg-slate-800 rounded-2xl sm:rounded-3xl p-3 sm:p-6 lg:p-4 2xl:p-6 shadow-xl shadow-gray-200/50 dark:shadow-none border border-gray-100 dark:border-slate-700">
          <h2 className="text-base sm:text-lg lg:text-base 2xl:text-lg font-bold text-gray-900 dark:text-white flex items-center gap-2 mb-3 sm:mb-6 lg:mb-4 2xl:mb-6">
              ...
              <div>
                  ...
                  <div className="relative group">
                      <input 
                          ...
                          className="w-full bg-gray-50 dark:bg-slate-900/50 border-2 border-transparent focus:border-primary/50 focus:bg-white dark:focus:bg-slate-900 rounded-xl sm:rounded-2xl px-4 py-2.5 sm:px-5 sm:py-3 lg:py-2.5 2xl:py-3 text-sm sm:text-base text-gray-900 dark:text-white font-bold transition-all outline-none"
                      />
                   ...
                   <div className="flex overflow-x-auto pb-4 gap-4 md:grid md:grid-cols-6 md:gap-4 md:pb-0 custom-scrollbar scroll-smooth snap-x">
                       {avatars.map((av) => (
                           <button
                               ...
                               className={clsx(
                                   "relative aspect-square w-16 h-16 md:w-20 md:h-20 lg:w-16 lg:h-16 2xl:w-20 2xl:h-20 rounded-full overflow-hidden border-2 transition-all group shrink-0 snap-center",
                                   avatar === av.id ? "border-primary scale-105 md:scale-110 lg:scale-105 2xl:scale-110 shadow-lg shadow-primary/20" : "border-transparent bg-slate-100 dark:bg-slate-900/50 hover:scale-105"
                               )}
                           >
                               <img 
          ...
          <div className="space-y-6">
                      ...
                      <div className="flex overflow-x-auto pb-4 gap-3 sm:flex-col sm:pb-0 sm:gap-2 custom-scrollbar scroll-smooth snap-x">
                          {[
                              ...
                              <button
                                ...
                                className={clsx(
                                    "relative flex-shrink-0 snap-center flex flex-col sm:flex-row items-center justify-center sm:justify-between gap-2 sm:gap-0 w-20 h-20 sm:w-auto sm:h-auto p-2 sm:px-4 sm:py-3 lg:px-3 lg:py-2 2xl:px-4 2xl:py-3 rounded-xl sm:rounded-xl text-[10px] sm:text-sm font-bold transition-all border-2",
                                    theme === t.id 
              ...
              <div className="grid grid-cols-2 gap-3 sm:gap-6">
                  ...
                  {[
                      ...
                      >
                          <div className={clsx("w-12 h-12 lg:w-10 lg:h-10 2xl:w-12 2xl:h-12 rounded-xl", t.color)} />
      ...
      {/* Data Management */}
       <div className="bg-white dark:bg-slate-800 rounded-2xl sm:rounded-3xl p-3 sm:p-6 lg:p-4 2xl:p-6 shadow-xl shadow-gray-200/50 dark:shadow-none border border-gray-100 dark:border-slate-700 relative overflow-hidden">
          <h2 className="text-base sm:text-lg lg:text-base 2xl:text-lg font-bold text-gray-900 dark:text-white flex items-center gap-2 mb-3 lg:mb-4 2xl:mb-6">
          ...
          <div className="grid grid-cols-3 gap-2 sm:gap-4 mb-4">
              ...
              <button 
                ...
                className="relative group flex flex-col items-center justify-center p-2 sm:p-5 lg:p-3 2xl:p-5 bg-white dark:bg-slate-800/50 rounded-2xl sm:rounded-3xl border border-gray-100 dark:border-slate-700/50 shadow-sm hover:shadow-xl hover:shadow-primary/5 transition-all disabled:opacity-50 overflow-hidden"
              >
                  <div className="w-8 h-8 sm:w-10 sm:h-10 lg:w-9 lg:h-9 2xl:w-10 2xl:h-10 rounded-xl bg-primary/10 flex items-center justify-center text-primary mb-1.5 sm:mb-2 group-hover:scale-110 transition-transform">
                    <Download size={16} className="sm:w-5 sm:h-5 lg:w-4 lg:h-4 2xl:w-5 2xl:h-5" />
                  </div>
              ...
              {/* Local Restore Box */}
               <label 
                className={clsx(
                    "relative group flex flex-col items-center justify-center p-2 sm:p-5 lg:p-3 2xl:p-5 bg-white dark:bg-slate-800/50 rounded-2xl sm:rounded-3xl border border-gray-100 dark:border-slate-700/50 shadow-sm hover:shadow-xl hover:shadow-indigo-500/5 transition-all cursor-pointer overflow-hidden",
                    status.type === 'loading' && "opacity-50 pointer-events-none"
                )}
              >
                  <div className="w-8 h-8 sm:w-10 sm:h-10 lg:w-9 lg:h-9 2xl:w-10 2xl:h-10 rounded-xl bg-indigo-100 dark:bg-indigo-900/30 flex items-center justify-center text-indigo-600 dark:text-indigo-400 mb-1.5 sm:mb-2 group-hover:scale-110 transition-transform">
                    <Upload size={16} className="sm:w-5 sm:h-5 lg:w-4 lg:h-4 2xl:w-5 2xl:h-5" />
                  </div>
              ...
              {/* Drive Backup Box */}
               <button 
                ...
                className="relative group flex flex-col items-center justify-center p-2 sm:p-5 lg:p-3 2xl:p-5 bg-gradient-to-br from-blue-50 to-emerald-50 dark:from-blue-900/10 dark:to-emerald-900/10 rounded-2xl sm:rounded-3xl border border-blue-100 dark:border-blue-900/30 shadow-sm hover:shadow-xl hover:shadow-blue-500/10 transition-all overflow-hidden"
              >
                  <div className="w-8 h-8 sm:w-10 sm:h-10 lg:w-9 lg:h-9 2xl:w-10 2xl:h-10 rounded-xl bg-white dark:bg-slate-900 shadow-md flex items-center justify-center text-blue-500 mb-1.5 sm:mb-2 group-hover:rotate-12 transition-transform">
                    <svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor" className="sm:w-5 sm:h-5 lg:w-4 lg:h-4 2xl:w-5 2xl:h-5">
          ...
          <motion.div 
            ...
            className="mt-8 lg:mt-4 2xl:mt-8"
          >
              <div className="relative overflow-hidden bg-gradient-to-br from-indigo-950 via-slate-900 to-black rounded-[2rem] sm:rounded-[2.5rem] p-4 sm:p-8 lg:p-5 2xl:p-8 text-white border border-white/10 shadow-2xl">
                  ...
                  <div className="relative flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left gap-4 sm:gap-6 mb-6 sm:mb-8 border-b border-white/5 pb-6 sm:pb-8 lg:mb-4 lg:pb-4 2xl:mb-8 2xl:pb-8">
                      <div className={clsx(
                          "w-16 h-16 sm:w-20 sm:h-20 lg:w-16 lg:h-16 2xl:w-20 2xl:h-20 rounded-3xl bg-white/5 backdrop-blur-md border border-white/10 flex items-center justify-center text-white shadow-inner transition-all duration-500 shrink-0",
                          syncStatus.isSyncing && "rotate-[360deg] scale-90 border-indigo-500/50 shadow-indigo-500/20"
                      )}>
                          <Cloud size={28} className={clsx("sm:w-9 sm:h-9 lg:w-7 lg:h-7 2xl:w-9 2xl:h-9", syncStatus.isSyncing ? "text-indigo-400 animate-pulse" : "text-white/80")} />
                      </div>
      ...
      {/* Danger Zone */}
       <div className="bg-red-50/50 dark:bg-red-900/10 rounded-2xl sm:rounded-3xl p-3 sm:p-6 border border-red-100 dark:border-red-900/30">
          <h2 className="text-base sm:text-lg font-bold text-red-600 dark:text-red-400 flex items-center gap-2 mb-2">
              <AlertCircle size={18} className="sm:w-5 sm:h-5 xl:w-4 xl:h-4 2xl:w-5 2xl:h-5" /> Danger Zone
          </h2>
