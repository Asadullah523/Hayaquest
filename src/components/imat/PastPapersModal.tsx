...
export const PastPapersModal: React.FC<PastPapersModalProps> = ({ 
    ...
    return createPortal(
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-fade-in">
            ...
            >
                {/* Header */}
                <div className="p-4 lg:p-5 2xl:p-6 border-b border-gray-100 dark:border-gray-800 flex items-center justify-between bg-white/50 dark:bg-gray-900/50 backdrop-blur-md sticky top-0 z-10">
                    <div className="flex items-center gap-4">
                        <div className="bg-primary/10 p-2 lg:p-3 2xl:p-3 rounded-2xl text-primary">
                            <GraduationCap className="w-6 h-6 lg:w-7 lg:h-7 2xl:w-8 2xl:h-8" />
                        </div>
                        <div>
                            <h2 className="text-lg lg:text-xl 2xl:text-2xl font-bold text-gray-900 dark:text-white">{title}</h2>
