            ...
            <div className="page-transition space-y-4 md:space-y-8 pb-20">
                ...
                <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 md:gap-6">
                    <div className="space-y-1">
                        ...
                        <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-2xl 2xl:text-4xl font-black text-slate-900 dark:text-white flex items-center gap-2 md:gap-3 tracking-tight">
                            <span className="bg-primary/10 p-1.5 md:p-2 rounded-xl md:rounded-2xl text-primary"><GraduationCap size={20} className="md:w-10 md:h-10 lg:w-8 lg:h-8 2xl:w-10 2xl:h-10" /></span>
                            IMAT Prep
                        </h1>
                        <p className="text-[10px] sm:text-xs md:text-lg lg:text-sm 2xl:text-lg text-slate-500 dark:text-slate-400 max-w-2xl font-medium" style={{ fontSize: 'clamp(0.625rem, 2vw, 1rem)' }}>
                            Master subjects and track your progress.
                        </p>
                    </div>

                    {/* Overall Progress Widget */}
                    <div className="glass-card px-3 sm:px-4 md:px-6 lg:px-4 2xl:px-6 py-2 sm:py-3 md:py-4 lg:py-3 2xl:py-4 rounded-xl sm:rounded-2xl md:rounded-[2rem] flex flex-row items-center justify-between md:justify-start gap-3 md:gap-5 min-w-0 md:min-w-[280px]">
                        ...
                        <div className="min-w-0">
                            ...
                            <div className="flex items-center gap-1.5 md:gap-2 text-primary font-bold text-[10px] sm:text-xs md:text-base lg:text-sm 2xl:text-base">
                                <TrendingUp size={12} className="flex-shrink-0 md:w-4 md:h-4 lg:w-3.5 lg:h-3.5 text-[10px] sm:text-xs" />
                ...
                <div>
                     <div className="grid grid-cols-3 md:grid-cols-2 lg:grid-cols-4 2xl:grid-cols-4 gap-2 md:gap-6">
                ...
                <div className="pt-8 border-t border-gray-100 dark:border-white/5">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 2xl:grid-cols-4 gap-6 pb-20">
                        {/* 1. Library Card */}
                        <div 
                            onClick={() => setView('library')}
                            className="group relative glass-card p-4 lg:p-4 2xl:p-6 rounded-2xl md:rounded-3xl cursor-pointer hover:-translate-y-1 transition-all duration-300 overflow-hidden flex flex-col min-h-[120px] max-h-[120px] md:min-h-[220px] md:max-h-none"
                        >
                            ...
                            <div className="z-10 relative">
                                <h3 className="text-base lg:text-base 2xl:text-xl font-bold text-gray-900 dark:text-white mb-0.5 md:mb-1">Study Library</h3>
                                <p className="text-xs lg:text-[11px] 2xl:text-sm text-gray-500 dark:text-gray-400 mb-2 md:mb-4 line-clamp-1 md:line-clamp-2" style={{ fontSize: 'clamp(0.75rem, 1.5vw, 0.875rem)' }}>
                        ...
                        >
                            ...
                            <div className="z-10 relative">
                                <h3 className="text-base lg:text-base 2xl:text-xl font-bold text-gray-900 dark:text-white mb-0.5 md:mb-1">Official Past Papers</h3>
                                <p className="text-xs lg:text-[11px] 2xl:text-sm text-gray-500 dark:text-gray-400 mb-2 md:mb-4 line-clamp-1 md:line-clamp-2" style={{ fontSize: 'clamp(0.75rem, 1.5vw, 0.875rem)' }}>
                        ...
                        >
                            ...
                            <div className="z-10 relative">
                                <h3 className="text-base lg:text-base 2xl:text-xl font-bold text-gray-900 dark:text-white mb-0.5 md:mb-1">Subject-wise Practice</h3>
                                <p className="text-xs lg:text-[11px] 2xl:text-sm text-gray-500 dark:text-gray-400 mb-2 md:mb-4 line-clamp-1 md:line-clamp-2" style={{ fontSize: 'clamp(0.75rem, 1.5vw, 0.875rem)' }}>
                         ...
                         <div className="hidden md:block group relative glass-card p-4 lg:p-4 2xl:p-6 rounded-3xl overflow-hidden flex flex-col justify-center items-center text-center opacity-70 hover:opacity-100 transition-opacity">
                            <p className="text-xs lg:text-[11px] 2xl:text-sm font-medium text-gray-400">More resources coming soon...</p>
                         </div>
