        ...
        <div className="border border-gray-200 dark:border-slate-700 rounded-2xl overflow-hidden bg-white dark:bg-slate-800/50 transition-all duration-300 hover:shadow-md">
            {/* Chapter Header */}
                <div 
                    ...
                    className="p-4 lg:p-3 2xl:p-5 flex items-center gap-3 sm:gap-4 cursor-pointer hover:bg-gray-50 dark:hover:bg-slate-700/50 transition-colors"
                >
                    ...
                    {topics.length === 0 ? (
                        ...
                        topics.map(topic => (
                            <div 
                                ...
                                className={`
                                    flex items-center gap-3 p-3 lg:p-2 2xl:p-3 rounded-xl transition-all border border-transparent cursor-pointer
                                    ${topic.isCompleted 
    ...
    return createPortal(
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-fade-in" onClick={onClose}>
            ...
            >
                {/* Header */}
                <div 
                    className="p-4 lg:p-4 2xl:p-6 shrink-0"
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3 sm:gap-4 flex-1 min-w-0">
                            ...
                            <div className="min-w-0">
                                <h2 className="text-lg lg:text-xl 2xl:text-2xl font-bold text-gray-900 dark:text-white flex items-center gap-2 truncate">
                                    {subject.name}
                                    {isSyllabusMode && <span className="px-1.5 py-0.5 rounded-full bg-primary/10 text-primary text-[8px] lg:text-[10px] 2xl:text-xs font-bold uppercase shrink-0">Syllabus</span>}
                                </h2>
                             ...
                             {currentSubjectTopics.length === 0 ? (
                                ...
                                currentSubjectTopics.map((topic: Topic) => (
                                    <div 
                                        ...
                                        onClick={() => topic.id && handleToggleTopic(topic.id)}
                                        className={`
                                            group relative flex items-center gap-3 p-3 lg:p-2 2xl:p-3 rounded-xl transition-all border cursor-pointer select-none
                                            ${topic.isCompleted 
                ...
                {!isSyllabusMode && (
                    <div className="p-4 lg:p-4 2xl:p-6 bg-gray-50 dark:bg-slate-800/50 border-t border-gray-100 dark:border-slate-700 shrink-0">
