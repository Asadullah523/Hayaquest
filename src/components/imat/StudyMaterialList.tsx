...
import type { StudyMaterial } from '../../data/types';
...
export const StudyMaterialList: React.FC<StudyMaterialListProps> = ({ materials }) => {
    return (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 animate-fade-in p-1">
            {materials.map((tip) => (
                <div 
                    key={tip.id}
                    className={`
                        p-4 lg:p-4 2xl:p-6 rounded-2xl glass-card border-none relative overflow-hidden group hover:-translate-y-1 transition-transform duration-300
                ...
                >
                    ...
                    <div className="relative z-10">
                        ...
                        <h3 className="text-base 2xl:text-lg font-bold text-gray-900 dark:text-white mb-2">
                            {tip.title}
                        </h3>
