...
export const Library: React.FC<LibraryProps> = ({ context = "IMAT", initialResources = imatResources }) => {
  ...
  const categories = ['All', 'Biology', 'Chemistry', 'Physics', 'Math', 'Logic', 'Past Papers', 'My Uploads'];
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 2xl:grid-cols-4 gap-6 pb-20">
        ...
        <div 
            className={`
                group relative h-full min-h-[220px] md:min-h-[280px] border-2 border-dashed rounded-[2rem] transition-all duration-300 cursor-pointer flex flex-col items-center justify-center gap-4 text-center p-6
