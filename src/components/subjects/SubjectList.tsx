    ...
    <div className="page-transition space-y-8 pb-20">
      ...
      <div>
           <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">All Subjects</h2>
            <div className="grid grid-cols-3 sm:grid-cols-3 lg:grid-cols-4 2xl:grid-cols-4 gap-2.5 sm:gap-6">
              ...
              <button 
                  ...
                  className="group relative h-[170px] w-full max-w-[110px] sm:max-w-none sm:h-72 md:h-80 lg:h-64 lg:w-48 2xl:h-80 2xl:w-60 mx-auto rounded-3xl border-2 border-dashed border-gray-300 dark:border-slate-700 bg-gray-50 dark:bg-slate-800/50 hover:bg-white dark:hover:bg-slate-800 hover:border-primary hover:shadow-xl transition-all duration-300 flex flex-col items-center justify-center gap-2 group/card overflow-hidden"
              >
                  <div className="w-10 h-10 lg:w-12 lg:h-12 2xl:w-16 2xl:h-16 rounded-xl sm:rounded-2xl bg-white dark:bg-slate-700 shadow-sm flex items-center justify-center group-hover:scale-110 group-hover:bg-primary group-hover:text-white transition-all duration-300 text-gray-400">
                      <Plus size={24} className="lg:w-6 lg:h-6 2xl:w-8 2xl:h-8" />
                  </div>
