...
const SubjectDetailContent: React.FC = () => {
  ...
  return (
    <div className="min-h-screen -m-4 lg:-m-6 2xl:-m-12 p-4 lg:p-6 2xl:p-12 bg-[#2d1b10] text-[#fdf5e6] font-sans selection:bg-[#d4b483] selection:text-[#1a120b]">
        {/* Background Texture */}
        ...
        <div className="relative z-10 max-w-5xl mx-auto space-y-8 animate-fade-in">
            {/* Header */}
            <div className="flex flex-col md:flex-row md:items-center gap-4 border-b border-[#C6A477]/20 pb-4 lg:pb-6 2xl:pb-8">
                <div className="flex items-center gap-3 md:gap-4">
                    ...
                    <div className="flex items-center gap-3 md:gap-4 flex-1">
                        <div className="w-8 h-8 lg:w-10 lg:h-10 2xl:w-12 2xl:h-12 bg-[#3d2b1f] border border-[#d4b483]/30 rounded-lg md:rounded-xl flex-shrink-0 flex items-center justify-center text-[#d4b483]">
                            <BookOpen className="w-4 h-4 lg:w-5 lg:h-5 2xl:w-6 2xl:h-6" />
                        </div>
                        <div className="min-w-0">
                            <h1 className="text-xl lg:text-2xl 2xl:text-4xl font-serif font-bold text-[#fdf5e6] dark:text-neon-indigo tracking-tight truncate drop-shadow-md">{subject?.name || 'Untitled Subject'}</h1>
                ...
                <div className="flex items-center gap-3 md:gap-6 bg-[#3d2b1f] p-3 lg:p-3 2xl:p-4 rounded-xl md:rounded-2xl border border-[#5a4030] shadow-xl md:ml-auto w-full md:w-auto">
                    <div className="relative w-10 h-10 lg:w-12 lg:h-12 2xl:w-16 2xl:h-16 flex-shrink-0 flex items-center justify-center">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 space-y-8">
                    {/* Add Topic Bar */}
                    <div className="bg-[#3d2b1f] p-0.5 md:p-1 rounded-lg md:rounded-xl border border-[#5a4030] shadow-2xl sticky top-4 lg:top-4 z-30 ring-1 ring-[#d4b483]/5">
                        <form onSubmit={handleAddTopic} className="relative flex items-center">
                            <input 
                                ...
                                className="w-full bg-transparent text-[#fdf5e6] placeholder-[#b8a594]/50 px-3 md:px-5 py-3 lg:py-3 2xl:py-4 outline-none font-serif text-sm lg:text-base 2xl:text-lg"
                            />
